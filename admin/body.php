...
<div id="bodyPan">
      <div id="bodyLeftPan">
                <div><h3><img src="images/adminpic.jpg"  width="40px" height="40px"/><span style="color:skyblue;font-style:italic">Hi! Admin <?=date('y-m-d'); ?></span></h3></div><br />
                <div><h2><span>why</span> education zone</h2></div>
		...
		<p>We only ask you to not remove "Design by Template World" and the link templateworld.com from the footer of the template.</p>
