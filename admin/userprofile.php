...
<style>
 ...
 .mydiv div span{
  ...
  <div style="font-size:24px;color:white;height:40px;text-shadow:1px 1px 1px white;margin:20px 20px 20px 20px;background: -moz-linear-gradient(left,#09F,white);padding-top:5px">
     USER DETAILS OF USERNAME <?=$row['username']?> :
  </div>
 <div style="width:100%;border:0px solid #DADADA;height:700px;margin-top:10px">
    <div style="border-right:1px solid #DADADA;float:left;height:700px;width:15%;margin-top:10px">
      <div style="border-bottom:1px solid #DADADA;margin-top:10px;padding-bottom:10px;margin-right:10px">><img src="<?=$row['picture']?>" width=180px height=180px /></div>
      <div></div>
    </div>
   
    <div  class="mydiv" style="">
       <div>USERNAME:<span><?=$row['username']?></span></div>
       <div>PASSWORD:<span><?=$row['password']?></span></div>
    ...
    <div style="margin-left:50px;border:1px solid #DADADA;float:left;clear:left;background:#EFEFEF;box-shadow:2px 2px 2px #EFEFEF"><a href="user.php" style="text-decoration:none">RETURN   TO USER PAGE</a></div>
 </div>
<?php
 include 'footer.php';
?>